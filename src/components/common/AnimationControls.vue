...
<template>
  <div class="flex place-content-end w-44 min-w-44 h-full">
    <div class="place-content-center">
      <div class="grid grid-rows-3 grid-cols-3 gap-4 text-center w-40 bg-zinc-700 p-4 rounded">
        <div></div>
        <div>
        ...
        <div class="col-span-3">
          <label>
            <span class="text-xs font-bold text-zinc-300">Zoom</span>
            <input class="w-full appearance-none bg-transparent [&::-webkit-slider-runnable-track]:h-[7px] [&::-webkit-slider-runnable-track]:rounded-full [&::-webkit-slider-runnable-track]:bg-zinc-800 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:h-[1em] [&::-webkit-slider-thumb]:w-[1em] [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-amber-500 [&::-webkit-slider-thumb]:border-0 [&::-moz-range-track]:h-[7px]              [&::-moz-range-track]:rounded-full              [&::-moz-range-track]:bg-zinc-800     [&::-moz-range-thumb]:appearance-none     [&::-moz-range-thumb]:h-[1em]     [&::-moz-range-thumb]:w-[1em]     [&::-moz-range-thumb]:rounded-full     [&::-moz-range-thumb]:bg-amber-500     [&::-moz-range-thumb]:border-0" @input="$emit('zoom-change', ($event.target as HTMLInputElement).value)" type="range" :min="minZoom" :max="maxZoom" :value="currentZoom">
          </label>
        </div>
        <div class="col-span-3">
          <label>
            <span class="text-xs font-bold text-zinc-300">Speed</span>
            <input class="w-full appearance-none bg-transparent [&::-webkit-slider-runnable-track]:h-[7px] [&::-webkit-slider-runnable-track]:rounded-full [&::-webkit-slider-runnable-track]:bg-zinc-800 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:h-[1em] [&::-webkit-slider-thumb]:w-[1em] [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-amber-500 [&::-webkit-slider-thumb]:border-0 [&::-moz-range-track]:h-[7px]              [&::-moz-range-track]:rounded-full              [&::-moz-range-track]:bg-zinc-800     [&::-moz-range-thumb]:appearance-none     [&::-moz-range-thumb]:h-[1em]     [&::-moz-range-thumb]:w-[1em]     [&::-moz-range-thumb]:rounded-full     [&::-moz-range-thumb]:bg-amber-500     [&::-moz-range-thumb]:border-0" @input="$emit('update:current-speed', ($event.target as HTMLInputElement).value)" type="range" :min="1" :max="24" :value="currentSpeed">
          </label>
        </div>
        <div class="col-span-3">
          <label>
            <span class="text-xs font-bold text-zinc-300">Frame</span>
            <input class="w-full appearance-none bg-transparent [&::-webkit-slider-runnable-track]:h-[7px] [&::-webkit-slider-runnable-track]:rounded-full [&::-webkit-slider-runnable-track]:bg-zinc-800 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:h-[1em] [&::-webkit-slider-thumb]:w-[1em] [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-amber-500 [&::-webkit-slider-thumb]:border-0 [&::-moz-range-track]:h-[7px]              [&::-moz-range-track]:rounded-full              [&::-moz-range-track]:bg-zinc-800     [&::-moz-range-thumb]:appearance-none     [&::-moz-range-thumb]:h-[1em]     [&::-moz-range-thumb]:w-[1em]     [&::-moz-range-thumb]:rounded-full     [&::-moz-range-thumb]:bg-amber-500     [&::-moz-range-thumb]:border-0" @input="$emit('update:current-frame', ($event.target as HTMLInputElement).value)" type="range" :min="0" :max="totalFrames - 1" :value="currentFrame">
          </label>
        </div>
